<?php
/**
 * SSO Login Handler — Repositório de Documentos
 * Fazer upload para: /repositorio/sso_login.php no servidor
 */

define('SSO_SYSTEM_KEY', 'repositorio');
...
// ── Configurar sessão igual ao public/index.php ───────────────
session_start();
...
try {
    ...
    // JOIN com roles para obter o nome do perfil
    ...
    // ── 6. Iniciar sessão (estrutura que o Repositório espera) ─
    session_regenerate_id(true);

    $_SESSION['user'] = [
        'id'            => $user['id'],
        'nome'          => $user['nome'],
        'role'          => $user['role_nome'] ?? null,
